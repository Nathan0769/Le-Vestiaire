...
import type { UserWishlistStats } from "@/types/user-public-collection";
import { useTranslations } from "next-intl";
import type { JerseyType } from "@/types/jersey";

interface UserWishlistStatsProps {
  stats: UserWishlistStats;
}

export function UserWishlistStats({ stats }: UserWishlistStatsProps) {
