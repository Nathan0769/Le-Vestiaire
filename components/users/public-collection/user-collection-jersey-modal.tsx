...
interface UserCollectionJerseyModalProps {
  isOpen: boolean;
  onClose: () => void;
...
function shouldShowAuthCard(item: UserCollectionItem): boolean {
...
export function UserCollectionJerseyModal({
  isOpen,
  onClose,
  collectionItem,
}: UserCollectionJerseyModalProps) {
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 @xl:pt-8">
          <div className="grid grid-cols-1 @xl:grid-cols-[380px_1fr] @4xl:grid-cols-[440px_1fr] gap-5 @4xl:gap-6 items-stretch">
            ...
            <div className="space-y-4">
              <JerseyHeader jersey={item.jersey} />
