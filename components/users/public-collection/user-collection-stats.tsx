...
import type { UserCollectionStats } from "@/types/user-public-collection";
import { useTranslations } from "next-intl";
import type { JerseyType } from "@/types/jersey";

interface UserCollectionStatsProps {
  stats: UserCollectionStats;
}

export function UserCollectionStats({ stats }: UserCollectionStatsProps) {
