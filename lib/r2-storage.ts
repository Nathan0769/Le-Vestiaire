...
const R2_PUBLIC_URLS: Record<string, string> = {
  ...
  ...(process.env.CLOUDFLARE_R2_PATCHES_BUCKET &&
    process.env.CLOUDFLARE_R2_PATCHES_PUBLIC_URL && {
      [process.env.CLOUDFLARE_R2_PATCHES_BUCKET]: process.env.CLOUDFLARE_R2_PATCHES_PUBLIC_URL,
    }),
